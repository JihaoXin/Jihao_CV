...
\PassOptionsToPackage{style=ieee,sorting=none,uniquename=init,defernumbers=true,maxbibnames=99,minbibnames=3}{biblatex}
...
\ifxetexorluatex % If you're using XeLaTeX or LuaLaTeX
  \usepackage{fontspec}
  %% Times + Helvetica: a more formal, traditional CV look
...
\leftheader{%
  {\LARGE\bfseries\sffamily Jihao Xin}

  \makefield{\faEnvelope[regular]}{\href{mailto:jihaoxin1998@gmail.com}{\texttt{jihaoxin1998@gmail.com}}}
  \makefield{\faLinkedin}{\href{https://www.linkedin.com/in/jihao-xin/}{\texttt{jihao-xin}}}
  \makefield{\faGlobe}{\href{https://jihaoxin.github.io/}{\texttt{jihaoxin.github.io}}}

  \makefield{\faWeixin}{\texttt{18805362617}}
  \makefield{\faBirthdayCake}{\texttt{Oct 27, 1998}}
  \makefield{\faPassport}{\texttt{China}}
  \makefield{\faMapMarker}{\texttt{Saudi Arabia}}
...
% Prevent large gaps from page-breaking within bibliography
\raggedbottom

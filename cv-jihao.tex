...
\leftheader{%
  ...
  \makefield{\faEnvelope[regular]}{\href{mailto:jihao.xin@kaust.edu.sa}{\texttt{jihao.xin@kaust.edu.sa}}}
  % \makefield{\faPhone}{\texttt{+966 560569149}}
  \makefield{\faLinkedin}
  {\href{https://www.linkedin.com/in/jihao-xin/}{\texttt{jihao-xin}}}

  %% Next line
  \makefield{\faGlobe}{\url{https://jihaoxin.github.io/}}
  \makefield{\faBirthdayCake}{\texttt{Oct 27, 1998}}
  \makefield{\faFlag}{\texttt{China}}
